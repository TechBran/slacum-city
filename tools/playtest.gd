...
const NAMED_ONLY_STRATEGY_IDS: Array[String] = [
	...
	# is the reason KNOB 4 ships OFF: on seed 9001 it ends the arc with the city's
	# one pressure zone at supply **0.0** and pressure **0.00**, which is gate
	# 21's own per-seed assertion failing. See `Balanced.lays_service_mains`.
