...
BUILDING_RULES: Dict[str, Any] = {
    ...
    "seed_rows": {
        ...
        "power_facility":    {"class": "vertical", "tax_class": "utility",     "footprints": ["3x3", "3x3", "3x3", "4x4", "4x4"], "pop": 0,  "jobs": 20, "power_kw": 0,   "water": D("0.96"),  "time_h": 18, "decay": D("0.00045"), "fire_p": D("0.00090"), "fire_load": 90, "crime": D("1.2"), "min_city": 0},
        "substation":        {"class": "standard", "tax_class": "utility",     "footprints": ["2x2", "2x2", "2x2", "2x2", "2x2"], "pop": 0,  "jobs": 4,  "power_kw": 0,   "water": D("0.0"),   "time_h": 8,  "decay": D("0.00045"), "fire_p": D("0.00070"), "fire_load": 55, "crime": D("1.5"), "min_city": 0},
        "water_facility":    {"class": "standard", "tax_class": "utility",     "footprints": ["3x3", "3x3", "3x3", "3x3", "4x4"], "pop": 0,  "jobs": 10, "power_kw": 60,  "water": D("0.0"),   "time_h": 12, "decay": D("0.00045"), "fire_p": D("0.00012"), "fire_load": 25, "crime": D("0.8"), "min_city": 0, "variants": ["source", "treatment", "pump", "tank", "booster"], "reference_variant": "pump", "footprints_are_reference_variant_only": True, "per_variant_footprint_source": "data/water.json components[variant][L].footprint_w/h"},
        "construction_yard": {"class": "steady",   "tax_class": "civic",       "footprints": ["2x2", "2x2", "2x2", "3x3", "3x3"], "pop": 0,  "jobs": 16, "power_kw": 12,  "water": D("0.16"),  "time_h": 10, "decay": D("0.00045"), "fire_p": D("0.00040"), "fire_load": 50, "crime": D("2.2"), "min_city": 0, "coverage_radius": 30},
    },
    "rounding": {
...
PUBLISHED: Dict[str, List[Tuple[Any, ...]]] = {
    ...
    "power_facility": [
        (0, 20, _P("0"), _P("0.96"), _P("18"), _P("20"), _P("0.000450"), _P("0.00090"), 90, _P("1.20"), _P("0.00"), _P("0.00"), 0),
        (0, 42, _P("0"), _P("2.4"), _P("31"), _P("34"), _P("0.000540"), _P("0.00115"), 180, _P("1.92"), _P("0.15"), _P("0.11"), 1),
        (0, 88, _P("0"), _P("6.2"), _P("52"), _P("57"), _P("0.000648"), _P("0.00147"), 360, _P("3.07"), _P("0.30"), _P("0.26"), 2),
        (0, 185, _P("0"), _P("16.0"), _P("88"), _P("98"), _P("0.000778"), _P("0.00189"), 720, _P("4.92"), _P("0.45"), _P("0.41"), 3),
        (0, 389, _P("0"), _P("40.5"), _P("150"), None, _P("0.000933"), _P("0.00242"), 1440, _P("7.86"), _P("0.60"), _P("0.56"), 4),
    ],
    "substation": [
        (0, 4, _P("0"), _P("0"), _P("8"), _P("8"), _P("0.000450"), _P("0.00070"), 55, _P("1.50"), _P("0.00"), _P("0.00"), 0),
        (0, 7, _P("0"), _P("0"), _P("12.5"), _P("12.5"), _P("0.000540"), _P("0.00090"), 110, _P("2.40"), _P("0.15"), _P("0.11"), 1),
        (0, 14, _P("0"), _P("0"), _P("19"), _P("19.5"), _P("0.000648"), _P("0.00115"), 220, _P("3.84"), _P("0.30"), _P("0.26"), 2),
        (0, 25, _P("0"), _P("0"), _P("30"), _P("30"), _P("0.000778"), _P("0.00147"), 440, _P("6.14"), _P("0.45"), _P("0.41"), 3),
        (0, 47, _P("0"), _P("0"), _P("46"), None, _P("0.000933"), _P("0.00188"), 880, _P("9.83"), _P("0.60"), _P("0.56"), 4),
    ],
    "water_facility": [
        (0, 10, _P("60"), _P("0"), _P("12"), _P("12"), _P("0.000450"), _P("0.00012"), 25, _P("0.80"), _P("0.00"), _P("0.00"), 0),
        (0, 19, _P("145"), _P("0"), _P("18.5"), _P("19"), _P("0.000540"), _P("0.00015"), 50, _P("1.28"), _P("0.15"), _P("0.11"), 1),  # jobs corrected by RR-19
        (0, 34, _P("360"), _P("0"), _P("29"), _P("29"), _P("0.000648"), _P("0.00020"), 100, _P("2.05"), _P("0.30"), _P("0.26"), 2),
        (0, 63, _P("880"), _P("0"), _P("45"), _P("45"), _P("0.000778"), _P("0.00025"), 200, _P("3.28"), _P("0.45"), _P("0.41"), 3),
        (0, 117, _P("2160"), _P("0"), _P("69"), None, _P("0.000933"), _P("0.00032"), 400, _P("5.24"), _P("0.60"), _P("0.56"), 4),
    ],
    "construction_yard": [
        (0, 16, _P("12"), _P("0.16"), _P("10"), _P("9"), _P("0.000450"), _P("0.00040"), 50, _P("2.20"), _P("0.00"), _P("0.00"), 0),
        (0, 25, _P("28"), _P("0.38"), _P("14"), _P("12.5"), _P("0.000540"), _P("0.00051"), 100, _P("3.52"), _P("0.15"), _P("0.11"), 1),
        (0, 38, _P("66"), _P("0.88"), _P("19.5"), _P("17.5"), _P("0.000648"), _P("0.00066"), 200, _P("5.63"), _P("0.30"), _P("0.26"), 2),  # fire p/gh corrected by RR-19
        (0, 60, _P("155"), _P("2.1"), _P("27"), _P("25"), _P("0.000778"), _P("0.00084"), 400, _P("9.01"), _P("0.45"), _P("0.41"), 3),
        (0, 92, _P("365"), _P("4.9"), _P("38"), None, _P("0.000933"), _P("0.00107"), 800, _P("14.42"), _P("0.60"), _P("0.56"), 4),
    ],
}
