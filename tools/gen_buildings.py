...
BUILDING_RULES: Dict[str, Any] = {
    ...
    "coverage_ladder": {
        "_l6_note": "The sixth rung of both ladders REPEATS the fifth, and that is a"
                    " derivation rather than an omission (doc 92 §23.2). These two"
    ...
    "sixth_level_archetypes": ["house", "apartment", "store", "office", "high_rise",
                               "data_center"],
    "_sixth_level_note": "ADDITIVE (doc 02 §2.14, doc 92 §23). Core Design Rule 5 said"
    ...
    "min_city_level_by_growth_class": {
        "_added_note": "ADDITIVE to `min_city_level_by_level`, which stays the default"
                       ...
                       " ruling of doc 92 §23.3: the `steady` class (house, store —"
...
## Core Design Rule 5, as amended by doc 92 §23: **five levels for every
