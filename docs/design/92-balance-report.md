...
## 27. Pass 10 — the feeder gets a card, and what that costs the matrix (Wave 11)
...
### 27.2 The matrix — 7 strategies × 3 seeds × 21 game-days, before and after
...
### 27.3 Why it did not move, which is the interesting half
...
### 27.4 The player's loop, walked end to end
...
### 27.5 Hashes — neutral on both cities, both paths
...
and none needed to be** — §27.2's matrix is identical, so there is nothing to
re-derive. Gate 18b's feeder-ceiling pin and gate 21's curriculum bounds are both
untouched.

### 27.7 What this pass did not do
