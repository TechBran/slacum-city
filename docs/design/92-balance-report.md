...
## 23. Pass 9 — the player surfaces, and what the curriculum costs once they exist (Wave 10)
...
### 23.2 The identity that matters
...
### 23.3 The arrival table, re-measured
...
### 23.4 Why `l3_streets` is 4 tiles and not 6 — the fit
...
### 23.5 Gate 21 — re-derived, not re-fitted
...
### 23.6 A correction to §22.3's published table
...
measurement. **§23.3's before/after pair is the number to trust**: one instrument,
one fork, both sides.

### 23.7 What this pass did not do
...
- **It did not re-rule §22.3's 10–40 game-hour band**, which level 3 was already
  outside before this pass. Flagged in §23.4 as the open question that owns it.
