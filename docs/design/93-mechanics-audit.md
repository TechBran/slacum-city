...
## U. Wave-14 merge rulings — how coverage is COUNTED, and how an id survives four siblings (2026-08-21)
...
against the rows beneath it. Report 98 §35 / RR-85 is the binding form; these are
the three decisions inside it that a mechanics reader needs.*

### U1. The row basis is a GREP plus two enumerated lists, and the promotion list is CLOSED
...
### U2. A colliding id stays with the row that CODE points at
...
### U3. A section HEADER is part of the id space, and a per-line `sed` does not know that
