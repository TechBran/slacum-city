...
| 2.13 | Benchmark-city fixture | **ABSENT** | `tools/gen_bench_city.py` does not exist. Doc 11 §2.13's device matrix is written against a 1,500-building city that nothing can generate. See **D-8**. |
