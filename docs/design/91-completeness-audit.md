...
| Suite | `tests/run_tests.gd` | ✅ ~~109 / 1,909 / 505,294~~ ~~112 files / 1,991 tests / 511,256 asserts~~ **117 files / 2,055 tests / 518,598 asserts** / 0 failed / 0 silent (2026-08-20; `tests/test_save_determinism_days.gd` is the new file this wave, and it is deliberately the most expensive one in the suite — see report 98 §26 RR-60) |
