...
##### 1. The zebra loop — the junction early-out (§2.1.2, RR-38)
...
##### 2. The construction layer's poses — a cache with an exact key (§2.16, RR-38)
...
##### 3. The congestion pass — the dirty set that cannot exist, and the one that can (doc 10 §9.3 C-3, doc 91 D-15, RR-39)
...
##### 4. Async saves — and the half that turned out to matter (doc 08 §2.14, RR-40)
