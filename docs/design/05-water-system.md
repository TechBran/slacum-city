...
**The last three, Wave 11 (doc 93 §J1, doc 92 §27) — and there is no water-node panel.** The open question the paragraph above used to end on is answered by ruling that the screen it asked for should not exist: the three verbs are two verbs at two moments, and the moments decide the surface.
