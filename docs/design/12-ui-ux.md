...
`transformer_stressed`, `transformer_troubled`, `transformer_failed`,
`transformer_repairing`, `transformer_crowded`. Rulings doc 93 §AY2/§AY3. Verbs
