...
## 17. WAVE 8 FOLLOW-UPS — the four render debts (binding)

### RR-26 — `rebuild()` may be a stateful diff, and the sort under it was `sort_custom` (render follow-ups, 2026-08-20)
...
### RR-27 — One-buffer MultiMesh uploads are a 2× REGRESSION in GDScript, and the layer's frame was never in the uploads (render follow-ups, 2026-08-20)
