...
### RR-38 — Three affordances shared one corner and nobody solved it; and a modal that outgrows the phone GROWS, it does not clip (doc 12 §2.3, §2.6, §2.13, D-16)
...
### RR-39 — No dev argument had ever reached the game on device, and the fix belongs in the plugin (doc 13 D-20, §2.6)
