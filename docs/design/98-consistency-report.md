...
## 28. WAVE 13 — the final ledger: the last two rulings, and the count (binding)
...
arithmetic. **RR-71 is the count**, and it supersedes RR-47's.*

### RR-69 — A starting purse is a RESERVE, and a difficulty is defined by the cushions it removes (docs 03 §2.9, 92 §32.7/§33, 93 §O1, 91 §20)
...
### RR-70 — A SECTION rung is sufficient when the body's shape holds; a rung is never a date stamp (docs 08 §2.8, 05 §3.2, 10 §3.2, 93 §O2)
...
### RR-71 — The count is 169 of 187, and a count table that drifts from its own rows has now done so three times (doc 91)
