...
## 17. WAVE 9 — the Fold 6 measurement pass (binding)
...
### RR-26 — The asphalt fragment ladder is a PRESET CEILING and an escape hatch, never a governor rung (doc 11 §2.1.2, §2.13)
...
### RR-27 — Pad shadows ship ON, and a shadow question asked at night is not a measurement (doc 11 §2.10b, §2.13)
...
### RR-28 — Every published frame number was taken at night, and at 1280×720; both are corrected (doc 11 §2.13)
...
### RR-29 — The `PERF` line doc 11 §7.4 is built on was never emitted, and `bench_device.sh` cannot launch a scenario (doc 11 §7.4, doc 13 §7)
...
### RR-30 — Save and load are synchronous, and nobody had measured them (doc 08 §2.7, doc 11 §2.13, doc 13 §2.9)
