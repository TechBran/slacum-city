...
## 17. WAVE 10 — the top of the ladder (binding)

### RR-26 — Core Design Rule 5 is amended to *five levels for every archetype, six for the growth stock*, and the sixth city level is granted because the sixth building rung pays for it (Wave 10, 2026-08-20)
