...
## 31. WAVE 14 — the street gets something to do, and three render rules come out of it (binding)
...
### RR-77 — A distance field is DATA, and `source_color` is a lie about it (docs 11 §2.17, 91 §11, 93 §P1)
...
**Filed as `A91-D-33` (Low), not fixed from this branch:** `VehicleView` and
...
### RR-78 — A screen-space affordance is laid out in SCREEN space (docs 11 §2.17, 93 §P2)
...
### RR-79 — An empty MultiMesh still costs a draw call (docs 11 §2.13/§2.17, 93 §P3)
