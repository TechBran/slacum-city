...
## 35. WAVE 15 — street polish: the five art items, and the one sim ruling (binding)

*Render/art fork off the Wave-14 street-life integration. Hash-neutral except
for RR-88, whose delta is published below; the balance gates are unread by
anything in this pass and both determinism COARSE baselines are unmoved.*

### RR-85 — A shadow you cannot see is not a shadow (docs 11 §2.11/§2.17, 93 §U3)
...
### RR-86 — An instance colour is LINEAR, and a palette fitted against a lift is unfitted (A91-D-36; docs 11 §2.12/§2.16, 91, 93 §U4)
...
(three tests), doc 91 A91-D-36, doc 93 §U4.

### RR-87 — RR-83's corollary, audited and closed (docs 11 §2.13/§2.16, 93 §S3)
...
### RR-88 — A field the renderer needs is a field the save owes it (docs 06 §2.16, 08 §2.8, 11 §2.17, 93 §U2)
...
`tests/test_street_life.gd` (five tests), doc 93 §U2. **`game/main.gd` is the
