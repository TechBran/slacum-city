...
## 35. WAVE 14 MERGE — the ledger is re-derived, and the ids are made unique (binding)

### RR-85 — A derived total is re-derived at the MERGE; a colliding id moves by a stated rule; and a sentence that names a command is re-RUN, never re-read (docs 91 §0/§17/§20.1b/§20.4/§20.6, 92, 93, 98 §24/§26)
...
doc 92 §39; doc 93 §U and six section headers; doc 98 §24b/§24c/§26b/§26c and
