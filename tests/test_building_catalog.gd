...
## Core Design Rule 5, as amended by doc 92 §23: five rungs for every
...
## `min_city_level_by_growth_class` overrides it (doc 92 §23.3: the `steady`
...
func test_catalog_loads() -> void:
	...
	assert_eq(catalog.max_level(), 6,
			"Core Design Rule 5 as amended (doc 92 §23): the tallest ladder is six")
...
func test_malformed_fixtures_rejected() -> void:
	...
	# Doc 92 §23.2: the sixth rung exists exactly where the rules say it does.
