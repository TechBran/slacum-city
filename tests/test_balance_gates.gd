...
##
## **WAVE-15 RE-MEASURE, AND NOT ONE BOUND MOVES** (doc 92 §35.4, report 98
## RR-78). The money pass raised the opening's income, and every bound in this
...
## for dropping `value created`** (doc 92 §35.5, report 98 RR-79).
##
