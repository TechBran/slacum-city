...
## Doc 92 §23.9: the curriculum grew a sixth level and it is a long one — the
...
func test_gate_20_the_city_level_ladder_is_reachable() -> void:
	...
	# **RE-FITTED, Wave 10 (doc 92 §23.6).** Six rungs became seven. The rung
...
##
## **RE-FITTED, Wave 10 (doc 92 §23.9).** The curriculum grew a sixth level and
...
## saving beat with a copper purchase in the middle of it. Doc 92 §23.8 is the
## measurement and §23.9 the ruling; the graduation level is allowed to be the
	...
	for seed_value in MATRIX_SEEDS:
		...
		assert_true(int(first_day_at[top]) <= CURRICULUM_TOP_LEVEL_DAYS,
				("seed %d finished the arc on game-day %d; the ruled bound is %d "
						+ "game-days (measured 31.1 / 33.5 / 34.3 — doc 92 §23.9)")
