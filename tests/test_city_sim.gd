...
func test_economy_settles_in_the_loop() -> void:
	...
	# **RE-FIT Wave 15 (doc 92 §35.2, report 98 RR-77 / RR-78): ≈ +$336.50 →
	# ≈ +$505.50, and the whole of it is two published constants.** RR-78's
	# founding assistance pays `+$172.00/gh` on game-day 0 and RR-77 retired the
